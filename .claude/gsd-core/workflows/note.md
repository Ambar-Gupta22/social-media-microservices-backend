...
- **Global scope**: `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/notes/`)
...
2. Glob `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/notes/` — works in any directory
