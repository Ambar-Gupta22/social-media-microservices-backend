...
```
Agent(
  prompt="Read C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/templates/SECURITY.md`
