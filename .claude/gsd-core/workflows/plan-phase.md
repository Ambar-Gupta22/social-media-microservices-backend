...
@C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/references/ui-brand.md
@C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/references/revision-loop.md
@C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/references/gate-prompts.md
...
**If found:**
1. Read template: `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/references/tdd.md to all eligible tasks:
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
**WALKING_SKELETON:** ${WALKING_SKELETON} (when true, the first deliverable must be a Walking Skeleton — Read the template at `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/references/skeleton-template.md` and produce SKELETON.md alongside PLAN.md.)
