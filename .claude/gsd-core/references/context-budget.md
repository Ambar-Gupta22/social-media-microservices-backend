...
The keys live in `.claude/settings.json` (project) or `C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/settings.json` (global) — **not** in `.planning/config.json`:
