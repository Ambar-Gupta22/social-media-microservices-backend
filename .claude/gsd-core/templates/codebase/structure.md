...
- Usage: Reference from command with `@C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/Vinita/Desktop/Web Development Projects/Social Media Microservices/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
